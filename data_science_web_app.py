...
st.write('This is a web app to classify the quality of your wine based on several features that you can see in the sidebar.'
        'Please adjust the value of each feature. After that, click on the Predict button at the bottom to see the'
...
t_sulf_diox = st.sidebar.slider(label = 'Total Sulfur Dioxide', min_value=6, max_value=289, value=145, step=1)
...
features = {'fixed acidity': fixed_acidity, 'volatile acidity': volatile_acidity, 'citric acid': citric_acid,
           ...
           'total sulfur dioxide': t_sulf_diox, 'density': density, 'pH': ph, 'sulphates': sulphates, 'alcohol': alcohol}
